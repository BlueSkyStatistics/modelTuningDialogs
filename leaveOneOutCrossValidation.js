...
var localization = {
    en: {
        ...
        navigation: "Leave One Out Cross Validation",
        ...
        ModelSelection: "Select a model category and then the type of model",
          help: {
            ...
            body: `
<b>Description</b></br>
Leave One Out Cross Validation uses the trainControl and train functions within the caret package to create a tuned/optimized model.<br/>
...
module.exports.item = new leaveOneOutCrossValidation().render()